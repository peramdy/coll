...
public class JedisClusterAdaptor extends JedisCluster implements MethodInterceptor {
    ...
    private static Logger logger = LoggerFactory.getLogger(JedisCluster.class);
    ...
    public JedisClusterAdaptor(HostAndPort node, int connectionTimeout, int soTimeout, int maxAttempts, GenericObjectPoolConfig poolConfig) {
        ...
        proxy(new Class[]{HostAndPort.class, int.class, int.class, int.class, GenericObjectPoolConfig.class}, new Object[]{node, connectionTimeout, soTimeout, maxAttempts, poolConfig});
    }
    ...
    public JedisClusterAdaptor(Set<HostAndPort> jedisClusterNode, int timeout, int maxAttempts, GenericObjectPoolConfig poolConfig) {
        ...
        proxy(new Class[]{Set.class, int.class, int.class, GenericObjectPoolConfig.class}, new Object[]{jedisClusterNode, timeout, maxAttempts, poolConfig});
    }
    ...
    public JedisClusterAdaptor(Set<HostAndPort> jedisClusterNode, int connectionTimeout, int soTimeout, int maxAttempts, GenericObjectPoolConfig poolConfig) {
        ...
        proxy(new Class[]{Set.class, int.class, int.class, int.class, GenericObjectPoolConfig.class}, new Object[]{jedisClusterNode, connectionTimeout, soTimeout, maxAttempts, poolConfig});
    }
    ...
    public JedisClusterAdaptor(Set<HostAndPort> jedisClusterNode, int connectionTimeout, int soTimeout, int maxAttempts, String password, GenericObjectPoolConfig poolConfig) {
        ...
        proxy(new Class[]{Set.class, int.class, int.class, int.class, String.class, GenericObjectPoolConfig.class}, new Object[]{jedisClusterNode, connectionTimeout, soTimeout, maxAttempts, password, poolConfig});
    }
    ...
    public Object intercept(Object enhance, Method method, Object[] args, MethodProxy methodProxy) throws Throwable {
        logger.info("jedis-cluster monitor");
        System.out.println("jedis-cluster monitor");

        String methodName = method.getName();
        logger.info("jedis-cluster method name :" + methodName);
        System.out.println("jedis-cluster method name :" + methodName);

        for (Object arg : args) {
            logger.info("jedis-cluster arg = " + arg.getClass().toString() + " : " + arg);
            System.out.println("jedis-cluster arg = " + arg.getClass().toString() + " : " + arg);
        }

        Object result = methodProxy.invokeSuper(enhance, args);

        logger.info("jedis-cluster result = " + result);
        System.out.println("jedis-cluster result = " + result);
